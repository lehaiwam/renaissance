...
const MedalScreen = ({navigation}) => {
    const currentMedalChampion = require('../../images/Medal-Champion-2022.jpg')
    return (
        <SafeAreaView style={styles.mainContainer}>

            <Text style={styles.mainHeader} >Medal Champion 2022</Text>

            <View style={styles.imageContainer}>
                <Image
                    style={styles.golferImage}
                    source={ currentMedalChampion }
                />               
            </View>

            <Text style={styles.championsName} >Sandile Sibiya</Text>
